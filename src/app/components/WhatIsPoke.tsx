  ...
  return (
    <section className="py-20 sm:py-28 px-4 sm:px-6">
      <div className="max-w-content mx-auto text-center">
        <p className="text-[0.65rem] tracking-[0.22em] uppercase text-faint dark:text-darkFaint mb-6 font-medium">
          About
        </p>
        <h2 className="text-2xl font-semibold tracking-tight text-ink dark:text-white mb-4">
          What is Poke?
        </h2>
        ...
        <a
          ...
          className="text-sm font-medium text-ink dark:text-white underline underline-offset-2 hover:opacity-60 transition-opacity"
        >
